        ...
        <div className="flex justify-end items-center">
          {dashboardUrl && (
            <a 
              ...
              className="group inline-flex items-center px-4 py-2 text-sm font-medium text-blue-700 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 transition-all duration-200 transform hover:scale-105"
            >
